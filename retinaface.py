...
class Retinaface(object):
    _defaults = {
        ...
        #   facenet训练完的权值路径
        # ----------------------------------------------------------------------#
        "facenet_model_path": 'model_data/lowlightfr.pth',
        # ----------------------------------------------------------------------#
    ...
    def detect_image(self, image):
        ...
        for face_encoding in face_encodings:
            ...
            l1 = np.linalg.norm(self.known_face_encodings[best_match_index] - face_encoding)
            print('最小距离为：' + str(l1))
            print('best_match_index为：' + str(best_match_index))
